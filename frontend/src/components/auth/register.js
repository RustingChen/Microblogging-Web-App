    ...
    render() { return (
            ...
            <form onSubmit={(e) => {
                ...
                <div className="form-group row">
                    <label className="col-md-2 col-form-label" for="username">Username</label>
                    ...
                    <div className="col-md-3">
                        <input type="text" id="display_name" className="form-control" ref={(node) => this.display_name = node } placeholder="Enter your display name" />
                    </div>
                </div>
                <div className="form-group row">
                    <label  className="col-md-2 col-form-label" for="email">Email</label>
                    <div className="col-md-3">
                        <input type="text" id="email" className="form-control" placeholder="xxx@xxx.xxx"
                ...
                <div className="form-group row">
                  ...
                  <div className="col-md-3">
                        <input type="text" id="birth" className="form-control" placeholder="12-02-2000"
                        pattern="\d\d-\d\d-\d\d\d\d" ref={(node) => this.birth = node }
                        title="birth should be the format of 01-01-1990" required/>
                  </div>
                  <label className="col-md-2 col-form-label" for="zipcode">Zipcode</label>
                  <div className="col-md-3">
                ...
                <div className="form-group row">
                    ...
                    <div className="col-md-3">
                        ...
                        className="form-control" placeholder="password again"required/>
                    </div>
                </div>
